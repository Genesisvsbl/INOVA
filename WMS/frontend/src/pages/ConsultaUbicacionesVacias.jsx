...
function imprimirInforme(locs, filtros) {
  ...
  const logoDark = `${window.location.origin}/INOVA-dark.png`;
  ...
  const html =
    ...
    // Encabezado sin fondo: logo oscuro + textos en azul (se ven al imprimir).
    `.hd{display:flex;align-items:center;gap:14px;padding:6px 2px 12px;border-bottom:3px solid #0a1f52}` +
    `.hd img{height:46px}` +
    ...
    `</style></head><body>` +
    `<div class="hd"><img src="${logoDark}" onerror="this.onerror=null;this.src='${logo}'"/><div><div class="t">INFORME DE UBICACIONES VACÍAS</div>` +
