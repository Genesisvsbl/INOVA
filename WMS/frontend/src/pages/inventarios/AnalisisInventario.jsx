...
const th = { padding: "10px 8px", fontSize: 12.5, fontWeight: 900, color: "#607080", background: "#fbfcfd", borderBottom: "1px solid #d9e2ec", whiteSpace: "nowrap", textAlign: "center" };
